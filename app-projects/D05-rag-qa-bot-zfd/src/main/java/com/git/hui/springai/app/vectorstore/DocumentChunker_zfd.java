 ...
 */
public class DocumentChunker_zfd {

    private final int maxChunkSize;
    private final int overlapSize;

    public static DocumentChunker_zfd DEFAULT_CHUNKER = new DocumentChunker_zfd();

    public DocumentChunker_zfd() {
        // 默认值：最大块大小500个字符，重叠50个字符
        this(500, 50);
    }

    public DocumentChunker_zfd(int maxChunkSize, int overlapSize) {
