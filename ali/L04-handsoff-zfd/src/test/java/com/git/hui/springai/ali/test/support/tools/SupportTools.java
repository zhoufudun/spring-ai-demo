 ...
 */
package com.git.hui.springai.ali.test.support.tools;

import com.alibaba.cloud.ai.graph.agent.tools.ToolContextHelper;
import com.git.hui.springai.ali.test.support.SupportStateConstants;
...
public final class SupportTools {
    ...
    public String recordWarrantyStatus(
        ...
        log.info("[recordWarrantyStatus]: {}", toolContext.getContext());
    ...
    public String recordIssueType(
        ...
        log.info("[recordIssueType]: {}", toolContext.getContext());
    ...
    public String provideSolution(
            ...
            ToolContext toolContext) {
        log.info("[provideSolution]: {}", toolContext.getContext());
    ...
    public String escalateToHuman(
            ...
            ToolContext toolContext) {
        log.info("[escalateToHuman]: {}", toolContext.getContext());
