 ...
 * @date 2026/3/12
 */
public class HandoffExpressOrderHook_zfd extends ModelHook{
    ...
    public HandoffExpressOrderHook_zfd() {
        ...
        this.stepConfigInterceptor = new StepConfigInterceptor_zfd(Map.of(
                ExpressOrderStateConstants.STEP_RECEIVE_INFO_COLLECTOR, new StepConfigInterceptor_zfd.StepConfig(RECEIVE_INFO_COLLECTOR_PROMPT, List.of(receiveAddress), List.of()),
                ExpressOrderStateConstants.STEP_SEND_INFO_COLLECTOR, new StepConfigInterceptor_zfd.StepConfig(SEND_INFO_COLLECTOR_PROMPT, List.of(sendAddress), List.of(ExpressOrderStateConstants.KEY_RECEIVE_INFO)),
                ExpressOrderStateConstants.STEP_EXPRESS_INFO_COLLECTOR, new StepConfigInterceptor_zfd.StepConfig(EXPRESS_INFO_COLLECTOR_PROMPT, List.of(expressInfo), List.of(ExpressOrderStateConstants.KEY_RECEIVE_INFO, ExpressOrderStateConstants.KEY_SEND_INFO)),
                ExpressOrderStateConstants.STEP_ORDER_CONFIRMATION, new StepConfigInterceptor_zfd.StepConfig(ORDER_CONFIRMATION_PROMPT, List.of(showExpressOrder, createOrder), List.of(ExpressOrderStateConstants.KEY_RECEIVE_INFO, ExpressOrderStateConstants.KEY_SEND_INFO, ExpressOrderStateConstants.KEY_EXPRESS_INFO))
        ));
    }
     ...
     * 定义：
     *
     * Agent State 里的每个 Key，在发生 State Update 时，应该怎么合并
     *
     * @return
     */
    @Override
